...
subsetyear <- 2011 # take only articles starting in this year

confthreshold <- 0.95 # if probability for a given name is above this threshold, we will assume it is a first name (we do this to avoid making unnecessary api requests)
